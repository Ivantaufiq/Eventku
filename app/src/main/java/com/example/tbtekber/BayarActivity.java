    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BayarActivity.this, Event5Activity.class);
                startActivity(intent);

                Toast.makeText(getApplicationContext(),"Berhasil Membeli Tiket",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BayarActivity.this, BeliTiketActivity.class);
                startActivity(intent);
            }
        });
